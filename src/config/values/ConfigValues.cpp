...
#define MS makeConfigValue
    ...
    return std::vector<SP<IValue>>{
        ...
        MS<Bool>("group:groupbar:drag_tabs", "whether a tab can be dragged along the groupbar with the left mouse button to reorder the group, without a modifier", true),
